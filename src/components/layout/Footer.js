...
import { Instagram, MapPin, Phone, Tiktok } from "lucide-react";
      ...
      <div className={styles.container}>
        <div className={styles.brand}>
          ...
          <p className={styles.mission}>
            L&apos;élégance du sur-mesure au cœur de Dakar. Élégance simple et
        ...
        <div className={styles.column}>
          ...
          <ul className={styles.linkList}>
            ...
            <li>
              <Link href="/bespoke">Sur-Mesure</Link>
            </li>
            <li>
        ...
        <div className={styles.column}>
          ...
          <ul className={styles.linkList}>
            <li>
              <a
                href="https://www.instagram.com/yesanda_/"
                target="_blank"
            ...
            <li>
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.tiktok.com/@yesanda__"
                style={{ display: "flex", gap: "8px", alignItems: "center" }}
              >
                <svg
                  fill="currentColor"
